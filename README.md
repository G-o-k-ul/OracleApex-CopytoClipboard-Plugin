...
├── src/
│   ├── da_copy_to_clipboard.sql                                 ← Plugin definition
│   └── pkg_copy_to_clipboard_plugin.sql                         ← PL/SQL Package
├── dist/
│   └── install.sql
└── README.md
```
...
```sql
pkg_copy_to_clipboard_plugin.sql
```

### Step 2 – Import Plugin into APEX
1. **Shared Components → Plug-ins → Import**
2. Upload: `da_copy_to_clipboard.sql`
